...
<head>
     <title>About</title>
     <link rel="stylesheet" href="hairCut.css">
</head>
                                   ...
                                   if (isset($details['image'])) {
                                        do {
                                             ...
                                             <div class="details">
                                                  ...
                                                  <a  href="bookingPage.php?bookId='.$details['styleName'].'&tableName=haircuts"> <button class="book">BOOK NOW</button></a>
