...
move_uploaded_file($_FILES['imageFile']['tmp_name'],$targetFile);
     ...
     $save = $con->query($check);
          if($save->num_rows>0)
          {
               echo "<script>alert('This HAIRCOLOUR NAME already Exist try new name !!!')</script>";
          }
          else
          {
               $insert = "insert into haircolour(styleName,price,description,stylistName,ageLimit,totalBooked,image,serviceName) values('".$_POST['sName']."',".$_POST['sPrice'].",'".$_POST['sDescription']."','".$_POST['sStylistname']."','".$_POST['sAgelimit']."','".$_POST['sBooked']."','".$imageFile."','".$_POST['serviceName']."')";
               $y=$con->query($insert);
                    ...
                    <div class="fullTable">
                         ...
                         <div class="singleLine">
                              ...
                              <div class="right">
                                   ...
                                   <input type="hidden" name="serviceName" value="haircolour">
                              </div>
                         </div>
                    </div>
