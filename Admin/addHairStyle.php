...
move_uploaded_file($_FILES['imageFile']['tmp_name'],$targetFile);
     ...
     require 'connect.php';
     $check = "select styleName from hairstyles where styleName ='".$_POST["sName"]."'";
     $save = $con->query($check);
          if($save->num_rows>0)
          {
               echo "<script>alert('This HAIRSTYLE NAME already Exist try new name !!!')</script>";
          }
          else
          {
               $insert = "insert into hairstyles(styleName,price,description,stylistName,ageLimit,totalBooked,image,serviceName) values('".$_POST['sName']."',".$_POST['sPrice'].",'".$_POST['sDescription']."','".$_POST['sStylistname']."','".$_POST['sAgelimit']."','".$_POST['sBooked']."','".$imageFile."','".$serviceName."')";
               $y=$con->query($insert);
...
<head>
     ...
     <link rel="stylesheet" href="addHairStyle.css">
                    ...
                    <div class="fullTable">
                         ...
                         <div class="singleLine">
                              ...
                              <div class="right">
                                   ...
                                   <input type="hidden" name="serviceName" value="hairstyles">
                              </div>
                         </div>
                    </div>
