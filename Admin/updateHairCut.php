...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="updateHairCut.css">
  ...
  <body>
          ...
          <div class="body">
                    ...
                    <div class="full">
                         <?php 
                             ...
                             {
                              $giveValue = "select * from haircuts where styleName='".$_POST['selectId']."'";
                              $savee= $con->query($giveValue);
                              $detailss=$savee->fetch_assoc();
                              
                              echo '<div class="firstHalf">
                              <hr>
                              <span>Update Hair Cut</span>
                         ...
                         ?>
                              <div class="fullTable">
                                   ...
                                   <div class="add">
                                   <input type="submit" class="butten" value="UPDATE HAIRCUT">
                                   </div>';   
                                             }                                          
                                             ?>
     ...
     <?php    
           ...
           if(isset($_POST['oldname'] ))  
           {
               ...
               $update="update haircuts set styleName='".$_POST['styleName']."',price='".$_POST['amount']."',description='".$_POST['description']."',stylistName='".$_POST['stylistName']."',ageLimit='".$_POST['ageLimit']."',totalBooked='".$_POST['totalBooked']."',image='".$imageName."' where styleName ='".$_POST['oldname']."'";
               $con->query($update);
