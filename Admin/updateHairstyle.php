  ...
  <body>
          ...
          <div class="body">
                    ...
                    <div class="full">
                         <?php 
                             ...
                             {
                              $giveValue = "select * from hairstyles where styleName='".$_POST['selectId']."'";
     ...
     <?php    
           ...
           if(isset($_POST['oldname'] ))  
           {
               ...
               $update="update hairstyles set styleName='".$_POST['styleName']."',price='".$_POST['amount']."',description='".$_POST['description']."',stylistName='".$_POST['stylistName']."',ageLimit='".$_POST['ageLimit']."',totalBooked='".$_POST['totalBooked']."',image='".$imageName."' where styleName ='".$_POST['oldname']."'";
               $con->query($update);
