...
<html lang="en">
  <head>
    <title>Remove Hair Cut</title>
    <link rel="stylesheet" href="adminHome.css" />
    <link rel="stylesheet" href="removeHairCut.css">
                    ...
                    <div class="fullTable">
                         <div class="selectItem">
                              ...
                              <?php
                                   ...
                                   echo "</select>";   
                                   echo "<input type='submit' class='submitButten' value='REMOVE HAIR CUT'>";      
                                      
                              ?>
                              <?php 
                                   if(isset($_POST['selectId']))
                                   {
                                        $delete = "delete from haircuts where styleName='".$_POST['selectId']."'";
                                         $con->query($delete);
